...
An operator provides your API URL and a scoped, expiring key. The release
candidate is `0.5.0-rc.12`; `latest` still selects the older `0.4.0` release. Pin
...
- `packages/deepagents` - optional Deep Agents/LangGraph integration (npm developer preview).
