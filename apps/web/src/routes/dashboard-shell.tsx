  ...
  return (
    <div className="dash">
      <aside className="dash-side">
        ...
        <div className="org-switcher static"><div className="org-ava">{orgInitial}</div><div style={{ flex: 1 }}><div className="org-name">{org.slug}</div><div className="org-plan">Organization</div></div></div>
