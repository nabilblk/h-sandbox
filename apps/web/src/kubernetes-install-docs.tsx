...
harakiri capabilities`,
  ...
  --image core.campus.clusterdiali.me/harakiri/templates/opencode@sha256:089f32fa775f6b5865a277da8bd00a2dc1d2784e55eb27a7072e22cf2ea1577b \\
...
export const kubernetesInstallDocs: DocPage = {
  ...
  body: <>
    ...
    <aside className="docs-notice"><p><strong>Source preview, not part of the pinned rc.9 bundle:</strong> the updated onboarding task offers eligible installed templates. After import, return to onboarding, select <strong>Refresh templates</strong>, choose the template and run the first sandbox. A readiness wait keeps the accepted sandbox; <strong>Check first task</strong> resumes observation without repeating its command. The task uses the template's working directory and a five-minute lifetime. Historical observations and their separate scope are covered in the <a href="#docs/usage-tutorial">usage tutorial</a>. The published rc.9 installation remains verified by the CLI/SDK task below.</p></aside>
    ...
    <p>Continue with <a href="#docs/backup-recovery">Backup and recovery</a> for the four-part recovery point, guarded database commands, verification checklist and supported rollback boundaries.</p>
