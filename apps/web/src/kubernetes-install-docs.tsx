...
export const kubernetesInstallDocs: DocPage = {
  ...
  body: <>
    ...
    <p>The <a href="https://github.com/nabilblk/h-sandbox/blob/main/docs/operations/standalone-recovery.md">coordinated recovery and upgrade qualification runbook</a> brings identity, encrypted Vault sources, workspace files and provider interruption into one procedure. Its new isolated amd64 test harness has local contract checks; native execution is still pending. A Helm configuration rollback within the same release does not prove cross-release or schema rollback safety.</p>
