...
try {
  ...
  await workspace.archive();
    ...
    <p>For framework-led agents, the optional <a href="#docs/deepagents">Deep Agents and LangGraph integration</a> supplies sandbox tools over this candidate SDK. The adapter is a separate source candidate, not a core SDK dependency.</p>
