...
export const sdkDemoSteps: SdkDemoStep[] = [
  ...
  },
  {
    ...
    language: "javascript", code: `import { HarakiriClient } from '@h-sandbox/sdk';
...
await client.waitForSandbox(sandbox.id, {
  ...
  },
  {
    ...
    language: "javascript", code: `const csv = await readFile(
...
await client.files.write(sandbox.id, {
  ...
  },
  {
    ...
    language: "javascript", code: `const model = process.env.OPENCODE_MODEL ?? 'opencode/mimo-v2.5-free';
await client.files.write(sandbox.id, {
  ...
  },
  {
    ...
    language: "javascript", code: sdkPromptCode,
  ...
  },
  {
    ...
    language: "javascript", code: sdkCommandCode,
  ...
  },
  {
    ...
    language: "javascript", code: `const started = await client.commands.start(sandbox.id, {
...
console.log('OpenCode job', started.command.id);`,
  ...
  },
  {
    ...
    language: "javascript", code: `const result = await client.commands.wait(
...
const logs = await client.commands.logs(
  ...
  },
  {
    ...
    language: "javascript", code: `const downloaded = await client.files.download(
...
const report = JSON.parse(
  ...
  },
  {
    ...
    language: "javascript", code: `assert.deepEqual(report, {
