...
export const visionDocs: DocPage = {
  ...
  lede: "An open-source control plane that turns sandbox infrastructure into a dependable developer experience for agent applications.",
  ...
  body: <div className="vision-doc">
    ...
    <section><h2>What belongs to whom</h2>
      <p>Harakiri is a control plane, not an agent framework and not a replacement for OpenSandbox. Keeping those roles separate lets each layer evolve without making application code depend on runtime internals.</p>
      <dl className="docs-ownership">
        ...
        <div><dt>OpenSandbox</dt><dd>Creates and operates the runtime. Harakiri uses its lifecycle, execution, file and networking interfaces through a provider adapter.</dd></div>
    ...
    <section><h2>Design principles</h2>
      <div className="docs-principles">
        ...
        <section><span>02</span><h3>Clear boundaries over shortcuts</h3><p>Runtime behavior stays behind the OpenSandbox adapter. Internal provider interfaces are not a promise that every runtime is interchangeable today.</p></section>
    ...
    <section><h2>Operate it on your terms</h2>
      <p>Self-hosting separates the product contract from where it runs. A deployment combines the API and workers, dashboard, PostgreSQL, Keycloak, registry and OpenSandbox-backed runtime. Operators configure public URLs, TLS, registry access, quotas and storage for their environment.</p>
      ...
      <p>Start with the <a href="#docs/security-model">security model</a>. For retained files, use <a href="#docs/workspace-operations">persistent storage operations</a> to plan enablement, retention, backups and recovery.</p>
    </section>
