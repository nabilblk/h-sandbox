...
5. Download and inspect the two published charts, then install the runtime and
   Harakiri control plane with the release's digest-pinned image overlay.
...
The reference pins Harakiri `0.5.0-rc.8`, the web-only `docs.2` correction and
OpenSandbox chart `0.2.2-harakiri.2`. See the [candidate receipt](release-notes/0.5.0-rc.8-delivery.md)
and [public image overlay](release-notes/0.5.0-rc.8-public-values.yaml).
