...
Placement reviewed September 7, 2026. A deployed candidate is not evidence that
...
| --- | --- | --- |
| [Documentation redesign deployment](active/documentation-redesign-deployment.md) | Completed source redesign and local acceptance; healthy rc.3 baseline | Web-only publication/deployment and public browser verification |
...
- [Documentation experience](completed/documentation-experience.md): restructured
  ...
  desktop/mobile browser acceptance. Verified locally; not deployed.

There are 29 plans in `completed/`, including the explicitly abandoned and
